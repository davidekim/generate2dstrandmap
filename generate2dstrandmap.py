...
parser.add_argument('--add_strand_connectivity', type=bool, default=True, help='Add strand connectivity lines.')
...
parser.add_argument('--svg_autorotate', type=bool, default=True, help='Rotate svg so barrel axis is vertical')
